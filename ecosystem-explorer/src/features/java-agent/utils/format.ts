...
const SEMCONV_URLS: Record<string, string> = {
  HTTP_CLIENT_SPANS: "https://opentelemetry.io/docs/specs/semconv/http/http-spans/#http-client-span",
  HTTP_SERVER_SPANS: "https://opentelemetry.io/docs/specs/semconv/http/http-spans/#http-server-span",
